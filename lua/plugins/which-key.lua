return {
  ...
  opts = {
    ...
    spec = {
      ...
      { "<leader>mh", group = "Heading Levels", icon = "" },
      { "<leader>me", group = "Box Editor", icon = "" },
      { "<leader>mn", group = "Notes", icon = "" },
      { "<leader>md", group = "Header Lists", icon = "" },
      { "<leader>mw", group = "Wiki", icon = "" },
      { "<leader>ml", group = "Lore", icon = "" },
      { "<leader>mlc", group = "Characters", icon = "" },
      { "<leader>mla", group = "Abilities", icon = "" },
      { "<leader>mls", group = "Spells", icon = "" },
      { "<leader>mll", group = "Locations", icon = "" },
      { "<leader>mlo", group = "Organizations", icon = "" },
      { "<leader>mlr", group = "Rules", icon = "" },
