...
vim.defer_fn(function()
  ...
  wk.add({
    ...
    { "<leader>mb1", desc = "Book 1 Index", icon = "1️⃣" },
    { "<leader>mb2", desc = "Book 2 Index", icon = "2️⃣" },
    { "<leader>mb3", desc = "Book 3 Index", icon = "3️⃣" },
    { "<leader>mb4", desc = "Book 4 Index", icon = "4️⃣" },
    { "<leader>mb5", desc = "Book 5 Index", icon = "5️⃣" },
    { "<leader>mb6", desc = "Book 6 Index", icon = "6️⃣" },
    { "<leader>mb7", desc = "Book 7 Index", icon = "7️⃣" },
    { "<leader>mb8", desc = "Book 8 Index", icon = "8️⃣" },
    { "<leader>mb9", desc = "Book 9 Index", icon = "9️⃣" },
